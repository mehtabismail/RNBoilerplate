...
import { chats_data_large } from '@/Config/dummyData'
...
const ChatContainer = () => {
    ...
    const RenderItem = ({ item }) => {
        return (
            <TouchableOpacity activeOpacity={0.8} style={[Layout.row, Gutters.xTinyBMargin]}>
                <View>
    ...
    return (
        <ScreenWrapper>
            <CustomHeader backButton centerText={"Chats"} />
            <CustomTextInput fieldName="search" placeholder="Search" handleChangeInput={handleChangeInput} />
            <View style={[Layout.fill, Gutters.xTinyTMargin]}>
                <FlashList
                    renderItem={RenderItem}
                    estimatedItemSize={50}
                    data={chats_data_large}
